    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 /*bg-amber-600">
        <main className="flex w-full flex-col items-start justify-start /*space-y-8">
          ...
          {/* 1.关于我们 */}
          <div className="flex w-5xl sm:w-3xl items-start justify-start flex-col mt-8">
          ...
          {/* 2.协议范围、目的及确认方式 */}
          <div className="flex w-5xl sm:w-3xl items-start justify-start flex-col mt-4">
            <h5 className=" mt-4 text-xl font-bold /*bg-amber-200">
              2. 协议范围、目的及确认方式
            </h5>
            <p className="mt-2 text-lg text-black font-base">
              ...
              <br />
              如您对本协议内容及页面提示信息有疑问，请勿进行下一步操作。
              <span className="font-bold">
                如您使用观澜问卷服务即视为您已阅读并同意本协议的约束。
              </span>
              <br />
          ...
          <div className="flex w-5xl sm:w-3xl items-start justify-start flex-col mt-4">
            ...
            <p className="mt-2 text-lg text-black font-bold">
              ...
              <br />
              （2）
              您或您的问卷填写者的电脑软件、系统、硬件、网络和通信线路出现故障；
              <br />
              （3）
              您或您的问卷填写者操作不当，包括但不限于提交错误的问卷答案、误删数据、错误理解题目含义导致填写偏差；
              <br />
              （4）
              因您分发的问卷内容、所收集的数据信息所引发的任何法律纠纷与责任；
              <br />
              （5） 其他我们无法控制或合理预见的情形。
            </p>
          </div>
          ...
          <div className="flex w-5xl sm:w-3xl items-start justify-start flex-col mt-4">
            ...
            <p className="mt-2 text-lg text-black font-base">
              ...
              <span className="font-bold">
                协商不成的，双方应向协议签订地有管辖权的人民法院以诉讼的方式解决。
              </span>
            </p>
          </div>
